...
public interface IwsReporte {
     ...
     * @param logos
     * @return
     *     returns wsclient.nova.RespReporte
     */
    ...
    @RequestWrapper(localName = "GetReporte", targetNamespace = "http://tempuri.org/", className = "wsclient.nova.GetReporte")
    @ResponseWrapper(localName = "GetReporteResponse", targetNamespace = "http://tempuri.org/", className = "wsclient.nova.GetReporteResponse")
