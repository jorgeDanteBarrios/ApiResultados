 ...
 * 
 */
@WebServiceClient(name = "wsLabCore", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://labswiss1.gda.mx:1054/wsReporte.svc?singleWsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://labswiss1.gda.mx:1054/wsReporte.svc?singleWsdl");
